...
- DB9 Cop pushdown is `SeqScan`-based only on this exact pair. Index scans and index lookup-style access paths remain local until a later paired milestone opens covering/index-only scan plus late materialization.
