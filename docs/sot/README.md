...
| `auth-rbac` | `./auth-rbac.md` | `src/auth/rbac.rs`<br>`src/sql/rbac.rs`<br>`src/protocol/handler/dynamic.rs` | `TBD` | `orm-tests.yml:test` | `PARTIAL` | Add CODEOWNERS; define GRANT/REVOKE enforcement scope and add regression coverage. |
