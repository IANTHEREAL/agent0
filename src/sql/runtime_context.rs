...
pub(crate) struct StatementRuntimeContext {
    ...
    /// Raw connect-token captured at login; forwarded to db9-backend's
    /// `/internal/connect-token/exchange` when this statement needs a
    /// fs9 v2 fs-plane token. None for password/connect-key logins.
    pub fs_exchange_bearer: Option<Arc<str>>,
    /// The PG role this session authenticated as (e.g. `admin`,
    /// `_db9_sys_readonly`). Used to derive the fs9 `scp` requested from
...
impl StatementRuntimeContext {
    ...
    pub(crate) fn from_session(
        ...
        Self::from_session_parts(session, tenant_keyspace, tikv_client)
    }
    ...
    pub(crate) fn from_session_with_store(
        ...
        Self::from_session_parts(session, tenant_keyspace, store.transaction_client())
    }
    ...
    fn from_session_parts(
        ...
        Self {
            ...
            fs_exchange_bearer: session.fs_exchange_bearer(),
...
pub(crate) fn wrap_with_statement_runtime_context<'a, T: Send + 'a>(
    ...
    let fs_exchange_bearer = runtime.fs_exchange_bearer.clone();
                ...
                crate::session_context::with_session_txn_tracker(
                    ...
                    crate::session_context::with_extension_txn_delta(
                        ...
                        crate::extensions::context::with_context_opts(
                            ...
                            .with_fs_exchange_bearer(fs_exchange_bearer)
