...
pub struct TransactionOptions {
    ...
    /// during pessimistic locking.  0 = use TiKV default timeout; negative = no
    /// wait (return error immediately if key is locked by another transaction).
    /// Only meaningful for pessimistic transactions.
    pub pessimistic_lock_wait_timeout: Option<i64>,
}
...
impl TransactionOptions {
    ...
    pub fn new_optimistic() -> TransactionOptions {
        TransactionOptions {
            ...
            pessimistic_lock_wait_timeout: None,
        }
    }
