...
--   - UPDATE FROM executes successfully in PG (UPDATE 5).
...
-- UPDATE FROM exceeds limit.
UPDATE dml_err_t1 SET val = dml_err_t2.val FROM dml_err_t2 WHERE dml_err_t1.id = dml_err_t2.id;
