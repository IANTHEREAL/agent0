...
-- 47 tests (UNION, INTERSECT, EXCEPT)
...
SELECT x FROM (SELECT x FROM xyz ORDER BY y) t1 UNION ALL SELECT x FROM (SELECT x FROM xyz ORDER BY z) t2 ORDER BY x;

-- Test 9: query (line 125)
(SELECT x FROM xyz ORDER BY y) UNION (SELECT x FROM xyz ORDER BY z) ORDER BY x;

-- Test 10: query (line 136)
SELECT x FROM (SELECT x FROM xyz ORDER BY y) t1 UNION ALL SELECT x FROM (SELECT x FROM xyz ORDER BY y, z) t2 ORDER BY x;
...
SELECT y FROM (SELECT y FROM xyz ORDER BY y) t1 INTERSECT ALL SELECT y FROM (SELECT y FROM xyz ORDER BY y) t2 ORDER BY y;

-- Test 15: query (line 190)
(SELECT y FROM xyz ORDER BY y) INTERSECT (SELECT y FROM xyz ORDER BY y) ORDER BY y;
...
SELECT x, y FROM xyz INTERSECT ALL SELECT y, x from xyz ORDER BY x, y;

-- Test 21: query (line 227)
SELECT x, y FROM xyz INTERSECT SELECT y, x from xyz ORDER BY x, y;

-- Test 22: query (line 234)
SELECT x FROM (SELECT x FROM xyz ORDER BY y) t1 INTERSECT ALL SELECT x FROM (SELECT x FROM xyz ORDER BY z) t2 ORDER BY x;
...
SELECT x FROM (SELECT x FROM xyz ORDER BY y) t1 INTERSECT ALL SELECT x FROM (SELECT x FROM xyz ORDER BY y, z) t2 ORDER BY x;
...
SELECT y FROM (SELECT y FROM xyz ORDER BY z) t1 INTERSECT ALL SELECT y FROM (SELECT y FROM xyz ORDER BY z) t2 ORDER BY y;

-- Test 27: query (line 286)
(SELECT y FROM xyz ORDER BY z) INTERSECT (SELECT y FROM xyz ORDER BY z) ORDER BY y;

-- Test 28: query (line 294)
SELECT x FROM (SELECT x, y FROM xyz INTERSECT ALL SELECT x, y FROM xyz) AS t(x, y) ORDER BY x;

-- Test 29: query (line 304)
SELECT x FROM ((SELECT x, y FROM xyz) INTERSECT (SELECT x, y FROM xyz)) AS t(x, y) ORDER BY x;
...
SELECT y FROM (SELECT y FROM xyz ORDER BY y) t1 EXCEPT ALL SELECT y FROM (SELECT y FROM xyz ORDER BY y) t2 ORDER BY y;

-- Test 33: query (line 335)
(SELECT y FROM xyz ORDER BY y) EXCEPT (SELECT y FROM xyz ORDER BY y) ORDER BY y;
...
SELECT x, y FROM xyz EXCEPT ALL SELECT y, x from xyz ORDER BY x, y;

-- Test 39: query (line 373)
SELECT x, y FROM xyz EXCEPT SELECT y, x from xyz ORDER BY x, y;

-- Test 40: query (line 382)
SELECT x FROM (SELECT x FROM xyz ORDER BY y) t1 EXCEPT ALL SELECT x FROM (SELECT y AS x FROM xyz ORDER BY z) t2 ORDER BY x;
...
SELECT x FROM (SELECT x FROM xyz ORDER BY y) t1 EXCEPT ALL SELECT x FROM (SELECT x FROM xyz ORDER BY y, z) t2 ORDER BY x;
...
SELECT y FROM (SELECT y FROM xyz ORDER BY z) t1 EXCEPT ALL SELECT y FROM (SELECT y FROM xyz ORDER BY z) t2 ORDER BY y;

-- Test 45: query (line 410)
(SELECT y FROM xyz ORDER BY z) EXCEPT (SELECT y FROM xyz ORDER BY z) ORDER BY y;

-- Test 46: query (line 415)
SELECT x FROM (SELECT x, y FROM xyz EXCEPT ALL SELECT x, y FROM xyz) AS t(x, y) ORDER BY x;

-- Test 47: query (line 419)
SELECT x FROM ((SELECT x, y FROM xyz) EXCEPT (SELECT x, y FROM xyz)) AS t(x, y) ORDER BY x;
