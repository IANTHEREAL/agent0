...
SELECT * FROM user_emails ORDER BY id;
...
SELECT * FROM active_users WHERE name LIKE 'A%' ORDER BY id;

-- 5. Query view with ORDER BY
SELECT * FROM active_users ORDER BY name;

-- 6. Query view with LIMIT
SELECT * FROM active_users ORDER BY id LIMIT 2;
...
SELECT * FROM high_value_users ORDER BY id;
...
FROM orders;
SELECT * FROM user_order_rank ORDER BY user_id, amount DESC;
...
FROM users;
SELECT * FROM user_safe ORDER BY id;
...
SELECT * FROM top_users WHERE id < 3 ORDER BY id;
